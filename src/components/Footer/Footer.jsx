...
const Footer = () => {
    return (
        <section>
            <footer className="footer max-w-7xl mx-auto p-10 bg-base-200 gap-96 font-bold text-base-content mt-12">
                <nav>
            ...
            <footer className="footer max-w-7xl mx-auto px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p className="font-bold">IT Career Development Ltd. <br />Providing reliable tech since 2024 <br /> <span className=" font-bold"> Proprietor By : SM SHAKIL</span></p>
                    
                </aside>
                <div>
                   <h1 className="text-2xl font-bold mt-12"> THANK YOU SO VERY MUCH</h1>
                </div>
